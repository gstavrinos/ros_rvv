...
ros_rvv is used to visualize robot view angles and viewed areas. This is achieved by utilizing the `Range` and `OccupancyGrid` message types. Note: The `Range` and `OccupancyGrid` messages generated by this package should not be used as sensor or navigation messages. They are purely for visualization purposes.
